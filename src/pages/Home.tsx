...
const Home = () => {
	return (
		<main className='flex flex-col xl:flex-row items-center justify-center xl:justify-around h-screen w-screen font-Bellefair bg-HomeMobile md:bg-HomeTablet xl:bg-HomeDesktop bg-cover bg-no-repeat bg-center'>
			...
			<div className='xl:relative xl:isolate xl:self-end xl:mb-40 overflow-visible group'>
				<div className='hidden xl:inline-block absolute inset-0 -z-10 bg-white/20 rounded-full h-36 w-36 md:h-52 md:w-52 xl:h-64 xl:w-64 xl:group-hover:scale-150 transition-all duration-100' />
				<Link
					to='/destination'
